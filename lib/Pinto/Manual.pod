# ABSTRACT: Entry point for Pinto documentation
...
=for :stopwords Jeffrey Ryan Thalhammer Imaginative Software Systems Stratopan
...
=item L<Pinto::Manual::Introduction>

Explains the goals, terminology, and concepts in L<Pinto>.

=item L<Pinto::Manual::Installing>
...
still in the alpha stage.  But it definitely worth investigation.
